...
```
cd existing_repo
git remote add origin https://code.roche.com/ghaffars/analytical_pipeline_template.git
git branch -M main
...
- [ ] [Set up project integrations](https://code.roche.com/ghaffars/analytical_pipeline_template/-/settings/integrations)
