...
# Modified by Rahul Mohan from GENENTECH in 2023.
#
...
def compute_pca(dense_gpu_array, n_components):
    start = time.time()
    pca_out = PCA(n_components=n_components).fit_transform(dense_gpu_array)
...
class RapidsSingleCellPipeline:
    ...
    def run_pca(self, n_components):
        pca_out = compute_pca(self.dense_gpu_array, n_components)
