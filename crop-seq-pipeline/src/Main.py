...
Dataset_HOME = "/gstore/scratch/u/ghaffars/Dataset/crc_NGS5570/" # the directory that contains all AnnData files stored on the disk

DatasetID = 'DS000016357'  # the dataset Id based on what you received when you submitted your dataset
...
subsample_dic = {'CTNNB1':0.5, 'TCF7L2':0.5} # a dictionary with genes of interest as keys and subsample size 
...
pVAL = 0.01 # the p-value cut-off for the significance
...
# create a dictionary to keep the parameters organized
ED_param = dict({'pVAL':pVAL, 'n':n, 'embeddings_key' : embeddings_key})
